...
@TestFixture(snap = Suggest.class,
        expectedOutputPath = "data/suggest/expected",
        expectedErrorPath = "data/suggest/expected")
public class SuggestTest {
    ...
    @TestFixture(suggestProperty = Suggest.PROP_ECHO,
            properties = "data/suggest/suggest_properties.json")
    public void suggest_WithSuggestProperty_WritesResultsToSpecialOutputView() {
    }
}