...
public class PropertyTypesTest {
    ...
    @TestFixture(snap = PropertyTypes.class,
            outputs = "output0",
            expectedOutputPath = "data/property_types/expected",
            expectedErrorPath = "data/property_types/expected",
            properties = "data/property_types/property_types_properties.json")
    public void propertyTypes_WithFieldsCompositesAndTables_OutputsEvaluatedValuesDocument() {
    }
}
